...
public class ActivityServiceImpl implements ActivityService {
    ...
    public CustomPage<SearchActivityResponse> searchActivity(SearchActivityRequest request) {
        ...
        Page<ActivityProjection> activities = activityRepository.searchActivity(request.getTitle(), request.getUserId(), request.getOrganizationId(), request.getStatuses(), pageable);
